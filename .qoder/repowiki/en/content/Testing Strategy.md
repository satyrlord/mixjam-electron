...
- [src/renderer/src/test/setup.ts:1-20](file://src/renderer/src/test/setup.ts#L1-L20)
- [src/renderer/src/test/electronApi.ts:1-62](file://src/renderer/src/test/electronApi.ts#L1-L62)
...
Test->>Setup : Initialize jsdom and theme
...
- [src/renderer/src/test/electronApi.ts:39-61](file://src/renderer/src/test/electronApi.ts#L39-L61)
...
- [src/renderer/src/test/electronApi.ts:41-42](file://src/renderer/src/test/electronApi.ts#L41-L42)
...
**Section sources**
- [src/renderer/src/test/setup.ts:17-19](file://src/renderer/src/test/setup.ts#L17-L19)
...
## Conclusion
MixJam Electron employs a layered testing strategy:
