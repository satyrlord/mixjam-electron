...
function createEchoformDelayProcessor() {
  ...
  return EchoformDelayProcessor
}

registerWorkletProcessor('echoform-delay-processor', createEchoformDelayProcessor as WorkletProcessorFactory)
