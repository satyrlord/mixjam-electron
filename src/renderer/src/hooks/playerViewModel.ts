...
export function createPlayerViewModel(app: AppState): PlayerViewModel {
  return {
    browser: {
      ...
      calibrationProgress: app.calibrationProgress,
      ...
      onStartUniformFolderCalibration: app.startUniformFolderCalibration,
      onCancelUniformFolderCalibration: app.cancelUniformFolderCalibration,
