...
function SupportedApp() {
  ...
  const browserProps = useMemo(() => ({
    ...
    sortBy: app.sortBy, sortDir: app.sortDir, tags: app.tags,
    ...
    app.selectedSampleDetail, app.selectedTagIds, app.sortBy, app.sortDir,
    app.tags, app.libraries, app.librarySyncState,
    app.setSearchQuery, app.loadMoreSamples, app.setSelectedSampleDetail, app.previewSample,
    handleToggleTagFilter, app.handleSortChange, app.rescanLibrary,
    ...
    app.reanalyzeSample, app.saveLibrary, app.deleteLibrary,
    app.applyLibrary
  ])
