...
**Spec Implementation Status:** IMPLEMENTED — BPM, key, and type analysis
...
pan from a filename. Lane position in the image is mix data a generator profile
declares, bounded by spec-021.
