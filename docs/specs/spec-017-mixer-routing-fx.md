...
2. Add-channel beyond 16 (up to 99).
...
- **Add channel (up to 99):** Button or "+" control in the mixer column footer.
  New channels start with default gain=1, pan=0. User assigns lanes to new
  channels via the routing UI.
...
Deferred full elaboration until spec-010 is defined. Expected scope:
...
- spec-010 (Per-Channel Audio Effects) — TBD
